  ...
  getRecettes():RecetteInterface[]{
    return [
      {id:1, 
        ...
        ingredients:[
          {
            nom:"Coquillettes au blé complet supérieur", 
            photo:"https://www.biocoop.fr/media/catalog/product/1/7/1716114063-3700937000209--coquillette_ble_ancien_1_2_complet_bio-pj1004.jpeg?quality=80&bg-color=255,255,255&fit=bounds&height=460&width=460&canvas=460:460",
            allergene:true,
            dosage:"80g"
          },
          {
